...
import pdfPhoto from "../images/siddhivinayak.jpg";
...
class PdfBodyOrnament extends React.Component {
  render() {
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                {" "}
                <b>Value : </b> &#x20B9; {information?.ornamentValue}{" "}
              </Typography>
            </div>
            <div>
              {/* body */}
              <table style={{ textAlign: "left" }} className="pdfTable">
                <tbody>
                  ...
                  <tr>
                    <th>Ornament Name </th>
                    <td> : {information?.ornamentName} </td>
                  </tr>
                  <tr>
                    <th>Ornament Type </th>
                    <td> : {information?.ornamentType} </td>
                  </tr>

                  <tr>
                    <th>Ornament Weight </th>
                    <td> : {information?.ornamentWeight} </td>
                  </tr>
                </tbody>
              </table>
            </div>
...
export default PdfBodyOrnament;
